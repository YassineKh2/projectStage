...
class UserController extends Controller {
	...
	public function getUsers() {
		...
		// ->editColumn('tenant_id', function (User $u) {
		// 	return $user->tenant->name;
		// })
			->addColumn('action', function ($row) {
				return '

				<a href="' . route("users.edit", $row->id) . '" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
	...
	public function index(UserDataTable $dataTable) {
		...
		return view('bo.users.index', compact('title', 'addurl'));
	...
	public function profil(Request $request) {
		...
		return view('bo.users.profile', compact('title', 'user', 'avatar'));
	}
}
