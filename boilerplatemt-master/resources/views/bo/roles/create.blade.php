...
<div class="d-flex flex-column-fluid">
    ...
    <div class="container">
        ...
        <div class="card card-custom">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{route('roles.store')}}" method="POST" id="Roleform">
	                {{ csrf_field() }}
	                <div class="box-body">
	                    <div class="form-group row">
	                        <label for="name" class="col-2 control-label">Name*</label>
	                        <div class="col-10">
	                            <input type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" id="name" placeholder="name" name="name" value="{{old('name')}}" required>
	                            @if ($errors->has('name'))
