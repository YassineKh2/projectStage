<div>
    ...
    <div class="box-body pt-3">
        <div class="form-group row">
            <label for="gender" class="col-2 control-label ">Gender</label>
            <div class="col-10">
                <input type="radio" id="Man" name="gender" value="Man" class="{{ $errors->has('gender') ? ' is-invalid' : '' }}">
                <label for="Man">Male</label>
                <input type="radio" id="Woman" name="gender" value="Woman" class="{{ $errors->has('gender') ? ' is-invalid' : '' }}">
    ...
    <div class="box-body">
        <div class="form-group row">
            ...
            <div class="col-10">
                <input type="text" class="form-control {{ $errors->has('first_name') ? ' is-invalid' : '' }}" id="first_name" placeholder="First Name" name="first_name" value="{{old('first_name')}}" >
        ...
        <div class="box-body">
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input type="text" class="form-control {{ $errors->has('last_name') ? ' is-invalid' : '' }}" id="last_name" placeholder="Last Name" name="last_name" value="{{old('last_name')}}" >
            ...
            <div class="box-body">
                ...
                <div class="box-body">
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input type="number" min="0" max="99999999" class="form-control {{ $errors->has('phone_number') ? ' is-invalid' : '' }}" id="phone_number" placeholder="Phone Number" name="phone_number" value="{{old('phone_number')}}" >
                    ...
                    <div class="box-body">
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input type="text" class="form-control {{ $errors->has('address') ? ' is-invalid' : '' }}" id="address" placeholder="Address" name="address" value="{{old('address')}}" >
    ...
    <div class="box-body">
        <div class="form-group row">
            ...
            <div class="col-10">
                <input type="text" class="form-control {{ $errors->has('activity_area') ? ' is-invalid' : '' }}" id="activity_area" placeholder="Activit Area" name="activity_area" value="{{old('activity_area')}}" >
                ...
                @endif
                        ...
                        <div class="box-body">
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input type="text" class="form-control {{ $errors->has('current_position') ? ' is-invalid' : '' }}" id="current_position" placeholder="Current Position" name="current_position" value="{{old('current_position')}}" >
